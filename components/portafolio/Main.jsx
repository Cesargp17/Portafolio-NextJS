...
export const Main = () => {
  ...
  return (
    <Container className="animate__animated animate__fadeIn" display='flex' justify='center' alignContent='center' css={{ height: '100vh', backgroundColor: `${ Theme === DarkTheme ? 'rgba(0, 0, 0, 0.6)' : '#0952A5' }` }}>
        ...
        <Container display='grid' justify='center' alignContent='center'>
            ...
            <Text h1 size={50} color='white' weight="bold"> Desarrollador web y móvil </Text><br />
        ...
        <a className="btn" href='#contacto' style={{ marginTop: 80 }}> CONTÁCTAME </a>
    </Container>
  )
}
